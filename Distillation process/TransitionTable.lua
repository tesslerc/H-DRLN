...
function trans:sample_one()
    ...
    if false and torch.uniform() < priorityMemProbability and (self.successEntries-self.recentMemSize-self.option_length) > self.histLen then
        prioritized = true
        while not valid do
